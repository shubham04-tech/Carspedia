        ...
        <div class="divtheme" >
            ...
            <tr align="center">
                ...
                <td><select  id="tertheme" onchange="choice()">
                        ...
                        <option value="i10">HYUNDAI GRAND i10 NOISE</option>
                        <option value="i20">HYUNDAI i20</option>
                        <option value="i20nline">HYUNDAI i20 N-LINE</option>
...
<script> 
  ...
  if(car === 'i10')
  {
      window.location.replace("i10.jsp");
  }
  if(car === 'i20')
  {
      window.location.replace("i20.jsp");
  }
  if(car === 'i20nline')
  {
      window.location.replace("i20nline.jsp");
  }
    }
  </script>