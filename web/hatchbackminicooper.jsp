        ...
        <div class="divtheme" >
            ...
            <tr align="center">
                ...
                <td><select  id="tertheme" onchange="choice()">
                        ...
                        <option value="cooperse">MINI COOPER SE</option>
                        <option value="countryman">MINI COUNTRYMAN</option>
...
<script> 
  ...
  if(car === 'cooper')
  {
      window.location.replace("cooper.jsp");
  }
  if(car === 'cooperse')
  {
      window.location.replace("cooperse.jsp");
  }
  if(car === 'countryman')
  {
      window.location.replace("countryman.jsp");
  }
    }
  </script>