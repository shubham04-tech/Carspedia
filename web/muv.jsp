...
<script> 
  ...
  if(car === 'mahindra')
  {
      window.location.replace("muvmahindra.jsp");
  }
    if(car === 'renault')
  {
      window.location.replace("muvrenault.jsp");
  }
  if(car === 'toyota')
  {
      window.location.replace("muvtoyota.jsp");
  }
      if(car === 'suzuki')
  {
      window.location.replace("muvmarutisuzuki.jsp");
  }
      }
