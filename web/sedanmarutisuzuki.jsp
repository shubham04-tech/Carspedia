        ...
        <div class="divtheme" >
            ...
            <tr align="center">
                ...
                <td><select  id="tertheme" onchange="choice()">
                        ...
                        <option value="dzire">MARUTI SUZUKI D-ZIRE </option>
                         <option value="ciaz">MARUTI SUZUKI CIAZ</option>
...
<script> 
  ...
  if(car === 'dzire')
  {
      window.location.replace("dzire.jsp");
  }
  if(car === 'ciaz')
  {
      window.location.replace("ciaz.jsp");
  }
