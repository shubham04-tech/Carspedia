        ...
        <div class="divtheme" >
            ...
            <tr align="center">
                ...
                <td><select  id="tertheme" onchange="choice()">
                        ...
                        <option value="forte">KIA FORTE</option>
...
<script> 
  ...
  if(car === 'k5')
  {
      window.location.replace("k5.jsp");
  }
  if(car === 'forte')
  {
      window.location.replace("forte.jsp");
  }
  if(car === 'rio')
  {
      window.location.replace("rio.jsp");
  }
  if(car === 'stinger')
  {
      window.location.replace("stinger.jsp");
  }
  </script>