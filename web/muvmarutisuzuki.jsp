        ...
        <div class="divtheme" >
            ...
            <tr align="center">
                ...
                <td><select  id="tertheme" onchange="choice()">
                        ...
                        <option value="xl6">MARUTI SUZUKI XL6</option>
                         <option value="ertiga">MARUTI SUZUKI ERTIGA</option>
                         <option value="invicto">MARUTI SUZUKI INVICTO</option>
...
<script> 
  ...
  if(car === 'xl6')
  {
      window.location.replace("xl6.jsp");
  }
  if(car === 'ertiga')
  {
      window.location.replace("ertiga.jsp");
  }
   if(car === 'invicto')
  {
      window.location.replace("invicto.jsp");
  }
      }
