            ...
            <tr align="center">
                ...
                <td><select  id="tertheme" onchange="choice()">
                        ...
                        <option value="bmwx5">BMW X5</option>
                         <option value="bmwx7">BMW X7</option>
                          <option value="bmwxm">BMW XM</option>
...
<script> 
  ...
  if(car === 'bmwx5')
  {
      window.location.replace("bmwx5.jsp");
  }
  if(car === 'bmwx7')
  {
      window.location.replace("bmwx7.jsp");
  }
  if(car === 'bmwxm')
  {
      window.location.replace("bmwxm.jsp");
  }
  if(car === 'landcruiser')
  {
      window.location.replace("landcruiser.jsp");
  }
    }
