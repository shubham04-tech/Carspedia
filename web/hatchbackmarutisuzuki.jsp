        ...
        <div class="divtheme" >
            ...
            <tr align="center">
                ...
                <td><select  id="tertheme" onchange="choice()">
                        ...
                        <option value="baleno">MARUTI SUZUKI BALENO</option>
                        <option value="swift">MARUTI SUZUKI SWIFT</option>
                        <option value="altok10">MARUTI SUZUKI ALTOK10</option>
...
<script> 
  ...
  if(car === 'baleno')
  {
      window.location.replace("baleno.jsp");
  }
  if(car === 'swift')
  {
      window.location.replace("swift.jsp");
  }
  if(car === 'altok10')
  {
      window.location.replace("altok10.jsp");
  }
    }
  </script>