        ...
        <div class="divtheme" >
            ...
            <tr align="center">
                ...
                <td><select  id="tertheme" onchange="choice()">
                        ...
                        <option value="aclass">MERCEDES BENZ A-CLASS</option>
                        <option value="cclass">MERCEDES BENZ C-CLASS</option>
...
<script> 
  ...
  if(car === 'aclass')
  {
      window.location.replace("aclass.jsp");
  }
  if(car === 'cclass')
  {
      window.location.replace("cclass.jsp");
  }
  if(car === 'sclass')
  {
      window.location.replace("sclass.jsp");
  }
