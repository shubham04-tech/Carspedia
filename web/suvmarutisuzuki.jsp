        ...
        <div class="divtheme" >
            ...
            <tr align="center">
                ...
                <td><select  id="tertheme" onchange="choice()">
                        ...
                        <option value="brezza">MARUTI SUZUKI BREZZA</option>
                         <option value="vitara">MARUTI SUZUKI GRAND VITARA</option>
...
<script> 
  ...
  if(car === 'brezza')
  {
      window.location.replace("brezza.jsp");
  }
  if(car === 'vitara')
  {
      window.location.replace("vitara.jsp");
  }
      }
